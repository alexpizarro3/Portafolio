...
My specialties include end-to-end BI solutions using Power BI, Power Query, Python, SQL, advanced Excel, VSCode, RStudio, and Google Apps Script.`,
  contact: {
    ...
    github: "https://github.com/alexpizarro3"
  },
  socials: [
    { name: "Email", icon: Mail, href: "mailto:alexpizarro3@gmail.com", color: "text-pink-600" },
    { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/alexis-pizarro-abarca-9018826b/", color: "text-blue-600" },
    { name: "GitHub", icon: Github, href: "https://github.com/alexpizarro3", color: "text-black dark:text-white" }
  ]
};
